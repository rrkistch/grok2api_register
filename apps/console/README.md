...
- `GROK_REGISTER_SOURCE_DIR=/home/codex/grok2api_register`
- `GROK_REGISTER_PYTHON=/home/codex/grok2api_register/.venv/bin/python`
...
```bash
cd /home/codex/grok2api_register/apps/console
python3 -m venv .venv
. .venv/bin/activate
